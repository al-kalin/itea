...
public class GMailService {
    ...
    String user = "alkalin.qa@gmail.com";
    String pass = "Kl45l;12nm";

    private volatile boolean isMessageReceived = false;
    private volatile String messageString;

    public static void main(String[] args) {
        String messageSubjectPartial = "alkalin, данное сообщение содержит ссылку для изменения пароля";
    ...
    /*public static void getUrl(String[] args) throws Exception {
